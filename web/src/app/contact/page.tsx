          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-headline font-bold text-sm tracking-tight">824 Acoustic Way, Suite 100</p>
                  <p className="font-accent italic text-xs text-neutral-500">Austin, Texas</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 flex items-center justify-center bg-surface-container-highest rounded-sm text-primary">
                ...
                <div>
                  <p className="font-headline font-bold text-sm tracking-tight">+1 (512) 555-0192</p>
                  <p className="font-accent italic text-xs text-neutral-500">Direct engineering line</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 flex items-center justify-center bg-surface-container-highest rounded-sm text-primary">
                ...
                <div>
                  <p className="font-headline font-bold text-sm tracking-tight">Mon &mdash; Fri, 09:00 &mdash; 18:00</p>
